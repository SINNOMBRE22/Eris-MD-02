...
const { initAuthCreds, BufferJSON, proto } = _b;

/**
 * bind(conn) conserva sincronización de eventos en conn.chats
 * (igual que versión original)
 */
function bind(conn) {
...
/**
 * KEY_MAP: renombradas todas las referencias "Ellen" → "Eris" para cumplir la regla de limpieza.
 * Antes: Ellensession -> Ellensessions
 * Ahora: ErisSession -> ErisSessions
 */
const KEY_MAP = {
  "pre-key": "preKeys",
  ErisSession: "ErisSessions",
