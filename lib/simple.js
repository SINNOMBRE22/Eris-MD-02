 ...
 */
// Interop: funciona con Baileys oficial (named exports) y con forks (todo en .default)
const _baileysNS = await import('@whiskeysockets/baileys')
const _baileys = _baileysNS.proto ? _baileysNS : (_baileysNS.default?.proto ? _baileysNS.default : _baileysNS)
const _makeWaSocket = typeof _baileysNS.default === 'function'
    ? _baileysNS.default
    : (_baileysNS.default?.default || _baileys.makeWASocket)
const {
    makeWALegacySocket,
    proto,
